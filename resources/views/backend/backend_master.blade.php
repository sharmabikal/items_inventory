...
<head>
  ...
  <!-- Google Font -->
  @section('add-item-page-style-files')
  ...
  @section('add-item-page-js-script')
  <script>
    $( function() {
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Items</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('viewItem')}}">VIEW Items</a></li>
            <li><a href="{{route('addItem')}}">ADD Items</a></li>
            <li><a href="{{route('addItemCategory')}}">ADD Item Category</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Computalaya_Inventory Dashboard
      </h1>
